...
Plan cherry blossom viewing trips — Japan's sakura forecasts, Wuhan's cherry gardens, and other blooming destinations with peak timing and best viewing spots. Wraps the flyai-cli to provide real-time travel data with booking links.
...
```bash
clawhub install cherry-blossom-trip
# or
npx skills add alibaba-flyai/flyai-skill/tree/main/skills/cherry-blossom-trip
```
...
# cherry-blossom-trip（中文说明）

规划赏樱之旅——日本樱花预报、武汉樱花园和其他赏花目的地，含花期预测和最佳观赏点。

## 概述

规划赏樱之旅——日本樱花预报、武汉樱花园和其他赏花目的地，含花期预测和最佳观赏点。本 Skill 基于 flyai-cli，提供实时旅行数据和预订链接。
